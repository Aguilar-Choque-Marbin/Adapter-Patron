...
ABall::ABall()
{
	...
	static ConstructorHelpers::FObjectFinder<UStaticMesh> BallMesh(TEXT("StaticMesh'/Game/TwinStick/Meshes/TwinStickProjectile.TwinStickProjectile'"));
	static ConstructorHelpers::FObjectFinder<UMaterialInstance> MaterialBall(TEXT("MaterialInstanceConstant'/Game/TwinStick/Meshes/BlueMaterial.BlueMaterial'"));
...
void ABall::Launch()
{
	//if (!BallLaunched) 
	//{
		SM_Ball->AddImpulse(FVector(200.0f, 900.0f, 0.0f), FName(), true);
		//BallLaunched = true;
