...
#define UE_PROJECT_NAME AdapterAuxiliatura
#define UE_TARGET_NAME AdapterAuxiliaturaEditor
#define UE_MODULE_NAME "AdapterAuxiliatura"
...
#define ADAPTERAUXILIATURA_API DLLEXPORT
